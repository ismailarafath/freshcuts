                    ...
                    <form onSubmit={(e) => { saveUsers(e) }}>
                        ...
                        <div className="naf-ams-tablediv" style={{ marginTop: '10px' }}>
                            <div className="naf-asm-table-row">
                                ...
                                <div className="naf-ams-table-cell table-inputs">
                                    <select className="arnewinput" onChange={getagetinfos}>
                                        <option value={user_agent}>-select-</option>
                                        {agentlist.map((i, index) => {
                                            return (
                                                <AgentList key={index} id={i.agent_id} name={i.agent_name}></AgentList>
                                            );
                                        })}

                                        {/* {agentlist.map((i, index) => {
                        <AgentList id={i.agent_id} name={i.agent_name}/>                      
                      })} */}
                                    </select>
                                </div>
                            </div>
                                                    ...
                                                    onChange={
                                                        (
                                                            ({ target: { value } }) => {
                                                                ...
                                                                let xvalue = value;
                                                                console.log(xvalue);
                                                                let m = months[xvalue].monid;
                                                                changeMonth(m)
                                                                setms(months[xvalue].monid)
                                                            }
                                                        )
                                                    }
