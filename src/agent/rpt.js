                ...
                <div className="naf-project-sub-container">
                    <div className="naf-ams-buttons-div">
                        ...
                        <div className="rightsidedescription">
                            <ul>
                                <li>Set Paper Size to A4 (210 x 297 mm)</li>
                                <li>In order to properly print certificates, you need to make sure that under more </li>
                                <li>setting options of printer “Background Graphics” is selected</li>
                            </ul>
                        </div>
                    </div>
...
export default ReportPageAgent;